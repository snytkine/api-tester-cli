...
class RegexMatchAssertionEvaluatorTest {
  ...
  void regexPatternMatchPasses() {
    ...
    FailureCollector collector = new FailureCollector();
    new RegexMatchAssertionEvaluator(
            new RegexMatchAssertion("response.body.json.$.code", "[A-Z]{3}\\d{3}"))
        .evaluate(response, collector);
  ...
  void partialMatchWithWildcardPasses() {
    ...
    FailureCollector collector = new FailureCollector();
    new RegexMatchAssertionEvaluator(
            new RegexMatchAssertion("response.body.json.$.message", ".*World.*"))
        .evaluate(response, collector);
  ...
  void invalidRegexPatternFails() {
    ...
    FailureCollector collector = new FailureCollector();
    new RegexMatchAssertionEvaluator(
            new RegexMatchAssertion("response.body.json.$.code", "[invalid("))
        .evaluate(response, collector);
  ...
  void headerMatchPasses() {
    ...
    FailureCollector collector = new FailureCollector();
    new RegexMatchAssertionEvaluator(
            new RegexMatchAssertion("response.headers.content-type", "application/json.*"))
        .evaluate(response, collector);
  ...
  void emailPatternMatchPasses() {
    ...
    FailureCollector collector = new FailureCollector();
    new RegexMatchAssertionEvaluator(
            new RegexMatchAssertion(
                "response.body.json.$.email",
