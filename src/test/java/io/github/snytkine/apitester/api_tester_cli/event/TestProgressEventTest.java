...
class TestProgressEventTest {
  ...
  void testCompletedPassCarriesNullFailureSummary() {
    TestProgressEvent event =
        new TestProgressEvent.TestCompleted(0, "get users", TestStatus.PASS, 123L, null);
  ...
  void testCompletedFailCarriesFailureSummary() {
    TestProgressEvent event =
        new TestProgressEvent.TestCompleted(
            1, "create item", TestStatus.FAIL, 42L, "expected 201 but was 400");
  ...
  void testCompletedErrorCarriesErrorMessage() {
    TestProgressEvent event =
        new TestProgressEvent.TestCompleted(
            3, "timeout test", TestStatus.ERROR, 5000L, "Connection refused");
