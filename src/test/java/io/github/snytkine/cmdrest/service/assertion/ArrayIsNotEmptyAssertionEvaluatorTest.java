...
class ArrayIsNotEmptyAssertionEvaluatorTest {
    ...
    @Test
    void nonEmptyArrayPasses() {
        ApiResponse response = responseWithJson(Map.of("items", List.of("a", "b")));

        FailureCollector collector = new FailureCollector();
        new ArrayIsNotEmptyAssertionEvaluator(new ArrayIsNotEmptyAssertion("response.body.json.$.items"))
    ...
    void missingPathFails() {
        ...
        FailureCollector collector = new FailureCollector();
        new ArrayIsNotEmptyAssertionEvaluator(new ArrayIsNotEmptyAssertion("response.body.json.$.missing"))
                .evaluate(response, collector);
