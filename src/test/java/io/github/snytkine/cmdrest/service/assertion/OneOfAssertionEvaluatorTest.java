...
class OneOfAssertionEvaluatorTest {
    ...
    void stringMatchesOneOfPasses() {
        ...
        new OneOfAssertionEvaluator(
                        new OneOfAssertion("response.body.json.$.status", List.of("active", "inactive", "pending")))
    ...
    void stringNotInListFails() {
        ...
        FailureCollector collector = new FailureCollector();
        new OneOfAssertionEvaluator(new OneOfAssertion("response.body.json.$.status", List.of("active", "inactive")))
                .evaluate(response, collector);
    ...
    void integerMatchesOneOfPasses() {
        ...
        FailureCollector collector = new FailureCollector();
        new OneOfAssertionEvaluator(new OneOfAssertion("response.body.json.$.code", List.of(200, 201, 204)))
                .evaluate(response, collector);
    ...
    void integerMatchesDoubleEquivalentPasses() {
        ...
        FailureCollector collector = new FailureCollector();
        new OneOfAssertionEvaluator(new OneOfAssertion("response.body.json.$.score", List.of(1.0, 2.0, 3.0)))
                .evaluate(response, collector);
    ...
    void booleanMatchesPasses() {
        ...
        FailureCollector collector = new FailureCollector();
        new OneOfAssertionEvaluator(new OneOfAssertion("response.body.json.$.flag", List.of(true, false)))
                .evaluate(response, collector);
    ...
    void nonScalarExpectedItemFails() {
        ...
        FailureCollector collector = new FailureCollector();
        new OneOfAssertionEvaluator(new OneOfAssertion(
    ...
    void missingPathFails() {
        ...
        FailureCollector collector = new FailureCollector();
        new OneOfAssertionEvaluator(new OneOfAssertion("response.body.json.$.missing", List.of("active", "inactive")))
                .evaluate(response, collector);
