...
import io.github.snytkine.cmdrest.commands.VersionCommand;
 ...
 * version check is disabled ({@code cmdrest.version-check.enabled=false}) so this test never
 * makes a real outbound network call to GitHub.
 */
@SpringBootTest(properties = {"DISABLE_INTERACTIVE_MODE=true", "cmdrest.version-check.enabled=false"})
class CmdRestApplicationContextTest {
