...
/**
 * Tests {@link CmdRestApplication#main(String[])} — the application entry point.
 *
 ...
 */
class CmdRestApplicationMainTest {
    ...
    void mainExecutesCommandInNonInteractiveModeWithoutHanging() {
        ...
        assertThatCode(() -> CmdRestApplication.main(new String[] {"version"})).doesNotThrowAnyException();
    }
}
