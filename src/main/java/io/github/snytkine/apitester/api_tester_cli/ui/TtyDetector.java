...
public final class TtyDetector {
    ...
    static boolean shouldUseUi(
            boolean forceUi, boolean noUi, boolean hasTty, boolean hasNoColor, boolean isCi, int terminalWidth) {
    ...
    public static boolean shouldUseUi(boolean forceUi, boolean noUi) {
        return shouldUseUi(forceUi, noUi, isTty(), !supportsColor(), isCI(), getTerminalWidth());
    }
