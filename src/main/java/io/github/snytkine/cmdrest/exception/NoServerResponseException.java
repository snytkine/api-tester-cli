 ...
 * io.github.snytkine.cmdrest.model.assertions.BaseServerResponseAssertion}: since
 * nothing came back, none of the test's declared assertions could be evaluated, so the test is
 * recorded as {@link io.github.snytkine.cmdrest.model.TestResult#FAILED} with zero
