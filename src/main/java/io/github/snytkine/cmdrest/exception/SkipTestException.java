 ...
 * io.github.snytkine.cmdrest.model.TestCase} declares a non-blank {@code skip}
 * field.
 *
 * <p>This exception is an internal control-flow signal used exclusively within {@link
 * io.github.snytkine.cmdrest.service.PureJavaTestEngine}: it is thrown from
 * {@code executeSingleTest} and caught in {@code runConfigurationSuite} to record a {@link
 * io.github.snytkine.cmdrest.model.TestResult#SKIPPED} outcome without sending
 ...
 * io.github.snytkine.cmdrest.model.TestCaseResult}.
 *
