...
import io.github.snytkine.cmdrest.util.VersionComparator;
...
public class VersionChecker {
     ...
     * @param properties binds the {@code cmdrest.version-check.*} configuration keys
    ...
    public void checkForUpdate() {
        if (!properties.enabled()) {
            log.debug("Version check disabled via cmdrest.version-check.enabled=false");
            return;
        }
